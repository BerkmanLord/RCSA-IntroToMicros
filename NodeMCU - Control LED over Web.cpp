...
void loop() {
  ...
  if (req.indexOf("/ledoff") != -1)  { //If URL is /ledoff then,
  ...
  else if(req.indexOf("/ledon") != -1) //If URL is /ledon then,
...
client.println("<br />");
 ...
 client.println("<a href=\"/ledon\"\"> <button style='FONT-SIZE: 50px; HEIGHT: 200px;WIDTH: 300px; 126px; Z-INDEX: 0; TOP: 200px;'> Turn On </button> </a>"); // Button to turn our LED on.

 client.println("<a href=\"/ledoff\"\"> <button style='COLOR: red; FONT-SIZE: 50px; HEIGHT: 200px; WIDTH: 300px; 126px; Z-INDEX: 0; TOP: 200px;'> Turn Off </button> </a>"); // Button to turn our LED off.
